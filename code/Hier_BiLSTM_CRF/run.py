...
from code.Hier_BiLSTM_CRF.model.Hier_BiLSTM_CRF import *
from code.Hier_BiLSTM_CRF.prepare_data import *
from code.Hier_BiLSTM_CRF.train import *
import torch
...
def main():
    ...
    parser.add_argument('--data_path', default = r"C:\Users\Deepak\OneDrive\Desktop\New folder\data\Hier_BiLSTM_CRF\train", type = str, help = 'Folder to store the annotated text files')
    parser.add_argument('--save_path', default = r'C:\Users\Deepak\OneDrive\Desktop\New folder\saved_models\Hier_BiLSTM_CRF', type = str, help = 'Folder where predictions and models will be saved')     
    parser.add_argument('--dataset_size', default = 100, type = int, help = 'Total no. of docs')
